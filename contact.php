    ...
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
                Мы всегда открыты для новых проектов и профессиональных дискуссий в сфере высоких технологий. 
                Свяжитесь с экспертной командой <strong><?= $domainTitle ?></strong> любым удобным для вас способом. 
                Наши специалисты в Берлине готовы проконсультировать вас по вопросам внедрения инноваций по будням с 09:00 до 18:00 (CET).
            </p>
            ...
            <div class="contact-cards">
                <div class="contact-card" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h2>Пишите нам</h2>
                    <p>Для общих вопросов, предложений и запросов на экспертную поддержку:</p>
                ...
                <div class="contact-card" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h2>Звоните</h2>
                    <p>Прямая линия поддержки в Германии для оперативной связи:</p>
                    <a href="tel:+493081215194" class="contact-link">+49 30 8121 5194</a>
                </div>
                ...
                <div class="contact-card" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h2>Наш офис</h2>
                    <p>Центр инновационных решений <?= $domainTitle ?> расположен по адресу:</p>
